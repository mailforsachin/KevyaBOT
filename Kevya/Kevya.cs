...
namespace Kevya
{
    ...
    public class Kevya : IBot
    {
        ...
        public Kevya(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
